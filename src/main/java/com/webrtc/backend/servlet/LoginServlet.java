...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            // Read credentials into a Map to handle flexible key names
            @SuppressWarnings("unchecked")
            Map<String, String> credentials = objectMapper.readValue(req.getReader(), Map.class);


             String username = credentials.get("username");         // The frontend sends 'username' as the key for the phone number
